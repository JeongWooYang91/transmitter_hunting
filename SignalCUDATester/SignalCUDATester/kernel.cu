...
**********************************************************************************/
int gatest[10][4] = {
	{ 4200, 21200, 24800, 31800 },
	{ -12800, -9600, -36200, -40000 },
	{ -19000, 16600, -14400, 31200 },
	{ 20600, 31600, 11400, 41400 },
	{ 2600, 11000, 6600, 23200 },
	{ 41000, -1000, 44600, 11600 },
	{ 20200, 22200, 6200, 19800 },
	{ -13800, 18000, -6600, 27000 },
	{ 11400, 34600, -6600, 27000 },
	{ 11400, 34600, -13200, 37200 }
};
void onKeyPress(unsigned char key, int x, int y) {
	if ('0' <= key && key <= '9') {
		...
		*/
		...
		ga.x1 = gatest[key - '0'][0];
		ga.y1 = gatest[key - '0'][1];
		ga.x2 = gatest[key - '0'][2];
		ga.y2 = gatest[key - '0'][3];
	}
	if ((key == 'p')) { //receiver
